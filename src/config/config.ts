...
export const TITLE_ESCROW_CREATOR_ROPSTEN =
  process.env.TITLE_ESCROW_CREATOR_ROPSTEN || "0xB0dE5E22bAc12820b6dbF6f63287B1ec44026c83";
export const TITLE_ESCROW_CREATOR_MAINET =
  process.env.TITLE_ESCROW_CREATOR_MAINET || "0x907A4D491A09D59Bcb5dC38eeb9d121ac47237F1";
export const TITLE_ESCROW_CREATOR_RINKEBY =
  process.env.TITLE_ESCROW_CREATOR_RINKEBY || "0xa51B8dAC076d5aC80507041146AC769542aAe195";
export const TITLE_ESCROW_CREATOR_LOCAL =
  process.env.TITLE_ESCROW_CREATOR_LOCAL || "0x4Bf7E4777a8D1b6EdD5F2d9b8582e2817F0B0953";
