...
describe("TitleEscrowCloneable", async () => {
  ...
  before("Initialising contract factories and accounts for TitleEscrow tests", async () => {
    ...
    TitleEscrowCloneableFactory = await ethers.getContractFactory("TitleEscrow");
    ERC721Factory = await ethers.getContractFactory("TradeTrustERC721");
    TitleEscrowClonerFactory = await ethers.getContractFactory("TitleEscrowCreator");
    CalculateSelector = await ethers.getContractFactory("CalculateSelector");
